...
- 3 tab pages (Home, Details, Settings) using the Tab Page Template
  * use the web page image as a refernce for the Home page and convert to a responsive view. add a visually appealling background gradient with some pastel colours to the first welcome card and use subtle colors to seperate other sections of the page.
